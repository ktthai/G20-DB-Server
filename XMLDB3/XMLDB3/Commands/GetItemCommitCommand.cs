...
namespace XMLDB3
{
	public class GetItemCommitCommand : BasicCommand
	{
		...
		public GetItemCommitCommand()
			: base(NETWORKMSG.NET_DB_ITEMMARKET_GETITEM_COMMIT)
		{
		}
		...
		public override bool DoProcess()
		{
			try
			{
				ItemMarketCommand command = new IMGetItemCommitCommand(ConfigManager.ItemMarketServerNo, m_CharacterName, m_TradeID);
