...
namespace XMLDB3
{
	public class InquiryMyPageCommand : BasicCommand
	{
		...
		public InquiryMyPageCommand()
			: base(NETWORKMSG.NET_DB_ITEMMARKET_INQUIRY_MYPAGE)
		{
		}
		...
		public override bool DoProcess()
		{
			try
			{
				ItemMarketCommand command = new IMInquiryMyPageCommand(ConfigManager.ItemMarketServerNo, m_CharacterName, m_PageNo, m_PageItemCount, m_bSale, IMSortingType.ExpireDate, bAsc: false);
