...
namespace XMLDB3
{
	public class ItemPurchaseCommand : BasicCommand
	{
		...
		public ItemPurchaseCommand()
			: base(NETWORKMSG.NET_DB_ITEMMARKET_ITEMPURCHASE)
		{
		}
		...
		public override bool DoProcess()
		{
			try
			{
				ItemMarketCommand command = new IMPurchaseCommand(ConfigManager.ItemMarketServerNo, m_CharacterName, m_NexonID, m_TradeID);
