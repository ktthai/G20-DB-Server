...
namespace XMLDB3
{
	public class SaleRequestCommitCommmand : BasicCommand
	{
		...
		public SaleRequestCommitCommmand()
			: base(NETWORKMSG.NET_DB_ITEMMARKET_SALE_REQUEST_COMMIT)
		{
		}
		...
		public override bool DoProcess()
		{
			try
			{
				ItemMarketCommand command = new IMSaleRequestCommitCommmand(ConfigManager.ItemMarketServerNo, m_CharacterName, m_TradeID);
