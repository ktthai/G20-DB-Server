...
namespace XMLDB3
{
	public class SaleRequestRollbackCommand : BasicCommand
	{
		...
		public SaleRequestRollbackCommand()
			: base(NETWORKMSG.NET_DB_ITEMMARKET_SALE_REQUEST_ROLLBACK)
		{
		}
		...
		public override bool DoProcess()
		{
			try
			{
				ItemMarketCommand command = new IMSaleRequestRollbackCommand(ConfigManager.ItemMarketServerNo, m_CharacterName, m_TradeID);
