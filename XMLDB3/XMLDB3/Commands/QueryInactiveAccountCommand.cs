...
namespace XMLDB3
{
	public class QueryInactiveAccountCommand : BasicCommand
	{
		private string m_strAccount;

		private bool m_Result;

		public QueryInactiveAccountCommand()
			: base(NETWORKMSG.NET_DB_ACCOUNT_QUERY_INACTIVE)
		{
		}
		...
		public override bool DoProcess()
		{
			...
			m_Result = QueryManager.Account.QueryInactiveAccount(m_strAccount);
			return true;
		}
