...
namespace XMLDB3
{
	public class PersonalRankingReadCommand : BasicCommand
	{
		...
		public PersonalRankingReadCommand()
			: base(NETWORKMSG.NET_DB_PERSONAL_RANKING_READ)
		{
		}
		...
		public override bool DoProcess()
		{
			...
			rankingTable_ = PersonalRankingTable.GetTable(QueryManager.PersonalRanking, rankingId_, sortType_, rankingCycleStartTime_, null, currentTime_);
