...
namespace XMLDB3
{
	public class SaleCancelCommand : BasicCommand
	{
		...
		public SaleCancelCommand()
			: base(NETWORKMSG.NET_DB_ITEMMARKET_SALE_CANCEL)
		{
		}
		...
		public override bool DoProcess()
		{
			try
			{
				ItemMarketCommand command = new IMSaleCancelCommand(ConfigManager.ItemMarketServerNo, m_CharacterName, m_TradeID);
