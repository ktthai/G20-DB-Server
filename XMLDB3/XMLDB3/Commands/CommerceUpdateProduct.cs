...
namespace XMLDB3
{
	public class CommerceUpdateProduct : BasicCommand
	{
		...
		public CommerceUpdateProduct()
			: base(NETWORKMSG.NET_DB_COMMERCE_T_UPDATE_PRODUCT)
		{
		}
		...
		public override bool DoProcess()
		{
			...
			m_result = QueryManager.GSCommerce.UpdateProduct(m_charId, m_ducat, m_commerceProducts);
			if (m_result != 0)
			{
