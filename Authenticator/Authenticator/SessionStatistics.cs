...
namespace Authenticator
{
	public class SessionStatistics
	{
		...
		public SessionStatistics(string _name, DateTime _start_time, string _status, DateTime _status_date, int _networksession)
		{
			m_Name = _name;
			m_StartTime = _start_time;
			m_Status = _status;
		...
		public Message ToMessage()
		{
			...
			message.WriteS64(m_StartTime.Ticks);
		...
		public Message FromMessage(Message _input)
		{
			...
			m_StartTime = new DateTime(_input.ReadS64());
